...
{
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$marks*$total.'</td><td>'.$marks.'</td><td>'.$wrong.'</td><td>'.$time.'&nbsp;min</td>
  </tr>';
}
}
$c=0;
